# Vault configuration for Server 2 (redis-02.example.com / 192.168.57.67)
...
api_addr = "https://redis-02.example.com:8200"
cluster_addr = "https://redis-02.example.com:8201"
