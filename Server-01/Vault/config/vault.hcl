# Vault configuration for Server 1 (redis-01.example.com / 192.168.57.66)
...
api_addr = "https://redis-01.example.com:8200"
cluster_addr = "https://redis-01.example.com:8201"
